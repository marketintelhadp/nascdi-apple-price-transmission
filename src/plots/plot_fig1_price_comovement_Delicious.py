...
VARIETY = "Delicious"   # change to "Delicious" if needed
...
plt.savefig(
    os.path.join(OUT, "fig1_price_comovement_Delicious.png"),
    dpi=300
)
plt.close()

print("✅ Figure 1 saved: fig1_price_comovement_Delicious.png")
